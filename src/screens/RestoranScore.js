...
export function RestoranScore({ navigation }) {
    ...
    React.useEffect(() => {
        console.log(Global.SelectedItem)
        setGrade(Global.SelectedItem)
    }, [])
                    ...
                    <View style={styles.RestoranInfoContainer}>
                        ...
                        <View style={styles.RestoranPuanContainer}>
                            ...
                            {Global.SelectedItem !== null &&
                                <Text style={styles.PuanText}>50.39</Text>
                            }

                        </View>

                        <View style={styles.RestoranInfo}>
                            <Text style={styles.RestoranInfoTitle}>01 Adana Kebapcisi</Text>
                ...
                {isDetail ?
                    <View style={{ marginTop: 20 }}>
                        ...
                        <View style={[styles.DataTableHeader, { marginTop: 20 }]}>
                            ...
                            <Text style={styles.DataTableHeaderTitle}>01 Adana Kebapcisi Puanlari</Text>
                        </View>

                        <View
                            style={styles.DataTableRow}>
                            <Text style={styles.DataTableRowText}>Zomato</Text>
                            <Text style={styles.DataTableRowText}>0.00/100</Text>
                        </View>

                        <View
                            style={styles.DataTableRow}>
                            <Text style={styles.DataTableRowText}>Tripadvisor</Text>
                            <Text style={styles.DataTableRowText}>53.57/100</Text>
                        </View>

                        <View
                            style={styles.DataTableRow}>
                            <Text style={styles.DataTableRowText}>Google</Text>
                            <Text style={styles.DataTableRowText}>65.47/100</Text>
                        </View>

                        <View
                            style={styles.DataTableRow}>
                            <Text style={styles.DataTableRowText}>Foursquare</Text>
                            <Text style={styles.DataTableRowText}>61.98/100</Text>
                        </View>

                        <View
                            style={styles.DataTableRow}>
                            <Text style={styles.DataTableRowText}>Facebook</Text>
                            <Text style={styles.DataTableRowText}>73.32/100</Text>
                        </View>
